...
namespace AuthorizedServer.Models
{
    ...
    public class SocialLoginModel
    {
        ...
        [Required]
        [DefaultValue("Token received from google or facebook")]
        ...
        [Required]
        [DefaultValue("ID given by google or facebook")]
    ...
    public class GoogleVerificationModel
    {
        ...
        [Required]
        [DefaultValue("ID given by google")]
    ...
    public class FacebookVerificationModel
    {
        ...
        [Required]
        [DefaultValue("ID given by facebook")]
        public string id { get; set; }
